...
public class JltfispCoProfileDto {
    ...
    private String intellectualPropertyNum;
    ...
    private String utilityModelPatentNum;
    ...
    private String integratedCircuitDesignNum;
	...
	public String getIntellectualPropertyNum() {
		return intellectualPropertyNum;
	}

	public void setIntellectualPropertyNum(String intellectualPropertyNum) {
	...
	public String getUtilityModelPatentNum() {
		return utilityModelPatentNum;
	}

	public void setUtilityModelPatentNum(String utilityModelPatentNum) {
	...
	public void setSoftwareCopyrightNum(String softwareCopyrightNum) {
		this.softwareCopyrightNum = softwareCopyrightNum;
	}

	public String getIntegratedCircuitDesignNum() {
		return integratedCircuitDesignNum;
	}

	public void setIntegratedCircuitDesignNum(String integratedCircuitDesignNum) {
