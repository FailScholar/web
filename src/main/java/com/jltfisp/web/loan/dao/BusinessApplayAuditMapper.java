...
public interface BusinessApplayAuditMapper extends BaseMapper<BusinessApplayAudit>{
     ...
     */
    BusinessApplayAudit checkApply(@Param("userId")Integer userId, @Param("parentType")String parentType);
     ...
     */
    BusinessApplayAudit getBusinessApplayAudit(@Param("userId")Integer userId, @Param("parentType")String parentType, @Param("state")Integer state);    
