       ...
       <p class="ntit">企业基本信息</p>
          ...
          <table width="100%" class="tab3">
              ...
              <tr>
                  ...
                  <td><input id="socialCreditCode" name="socialCreditCode" type="text" value="${socialCode}" readonly="readonly" class="txt validate[required,custom[onlyLetterNumber],minSize[9],maxSize[20]]" placeholder="请输入组织机构代码" /></td>
              ...
              <tr>
                  ...
                  <td colspan="3">
                      <input id="registeredAddress" name="registeredAddress" value="${jlfispPsBaseDto.registeredAddress }"  type="text validate[required,minSize[2],maxSize[50]]" placeholder="请输入注册地地址"  class="txt" />
                  </td>
              </tr>
              <tr>
                  ...
                  <td colspan="3">
                      ...
                      <input id="officeAddress" name="officeAddress" type="text" value="${jlfispPsBaseDto.officeAddress }" class="txt validate[required,minSize[2],maxSize[50]]" placeholder="请输入详细地址" />
                  </td>
              </tr>
              <tr>
          ...
          <#if jlfispPsBaseDto.jltfispPsInfoList?? && (jlfispPsBaseDto.jltfispPsInfoList?size > 0) >
            <#list jlfispPsBaseDto.jltfispPsInfoList as jltfispPsInfoList>
               ...
               <tr>
                  <th style="width:8%">${loanformManage.infoContractNumber}</th>
               ...
               <tr>
                  ...
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].repaymentDate" value="${jltfispPsInfoList.repaymentDate}" type="text" class="txt shijihuankuanri" placeholder="请输入实际还款日" onClick="WdatePicker({readOnly:true})" /></td>
               ...
               <tr>
                  ...
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].lendDate" type="text" value="${jltfispPsInfoList.lendDate}" class="txt  shijifangdairi" placeholder="请输入实际放贷日" onClick="WdatePicker({readOnly:true})" /></td>
               ...
               <tr>
                  <th>${loanformManage.infoRepaymentDate}</th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].repaymentDate" value="${jltfispPsInfoList.repaymentDate}" type="text" class="txt" placeholder="请输入实际还款日" onClick="WdatePicker({readOnly:true})"/></td>
                  <th>${loanformManage.infoPrincipalInterest}</th>
               ...
               <tr>
                  <th>${loanformManage.infoLendDate}</th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].lendDate" type="text" value="${jltfispPsInfoList.lendDate}" class="txt" placeholder="请输入实际放贷日" onClick="WdatePicker({readOnly:true})"/></td>
                  <th>${loanformManage.infoLoanTerm}</th>
          ...
          <table width="100%" class="tab3 module">
              ...
              <tr>
                  <th>${loanformManage.infoRepaymentDate}</th>
                  <td><input name="jltfispPsInfoList[0].repaymentDate" type="text" class="txt" placeholder="请输入实际还款日" onClick="WdatePicker({readOnly:true})" /></td>
                  <th>${loanformManage.infoPrincipalInterest}</th>
              ...
              <tr>
                  <th>${loanformManage.infoLendDate}</th>
                  <td><input name="jltfispPsInfoList[0].lendDate" type="text" class="txt " placeholder="请输入实际放贷日" onClick="WdatePicker({readOnly:true})"  /></td>
                  <th>${loanformManage.infoLoanTerm}</th>
