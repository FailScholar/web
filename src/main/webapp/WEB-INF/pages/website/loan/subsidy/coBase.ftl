       ...
       <p class="ntit">企业基本信息</p>
          ...
          <table width="100%" class="tab3">
              ...
              <tr>
                  ...
                  <td><input id="socialCreditCode" name="socialCreditCode" type="text" value="${jlfispPsBaseDto.socialCreditCode}" class="txt validate[required,custom[onlyLetterNumber],minSize[9],maxSize[20]]" placeholder="请输入" /></td>
              ...
              <tr>
                  ...
                  <td><input id="loanBankName" name="loanBankName" value="${jlfispPsBaseDto.loanBankName }" type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入" /></td>
                  <th><b class="red">*</b>注册资金</th>
                  <td><input id="registeredCapital" name="registeredCapital" value="${jlfispPsBaseDto.registeredCapital }"   type="text" class="txt validate[required,custom[onlyNumberSp],minSize[1],maxSize[10]]" />万元</td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td colspan="3">
                      ...
                      <input id="officeAddress" name="officeAddress" type="text" value="${jlfispPsBaseDto.officeAddress }" class="txt validate[required,minSize[2],maxSize[1000]]" placeholder="详细地址" />
                  </td>
              </tr>
              <tr>
          ...
          <#if jlfispPsBaseDto.jltfispPsInfoList?? && (jlfispPsBaseDto.jltfispPsInfoList?size > 0) >
            <#list jlfispPsBaseDto.jltfispPsInfoList as jltfispPsInfoList>
               ...
               <tr>
                  <th><b class="red">*</b><b>保单号</b></th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].policyNumber" value="${jltfispPsInfoList.policyNumber}" type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入" /></td>
                  <th><b class="red">*</b><b>担保金额</b></th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].premiumMoney" value="${jltfispPsInfoList.premiumMoney}" type="text" class="txt validate[required,minSize[1],maxSize[10]]" placeholder="请输入" />万元</td>
               </tr>
               <tr>
                  <th><b class="red">*</b><b>贷款银行</b></th>
                  <td>
                      <input name="jltfispPsInfoList[${jltfispPsInfoList_index}].loanBank" value="${jltfispPsInfoList.loanBank}" type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入" />
                  </td>
                  <th><b class="red">*</b><b>保险/担保公司</b></th>
                  <td>
               ...
               <tr>
                  <th>实际支付保额金额</th>
                   <td colspan="3"><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].loanMoney" value="${jltfispPsInfoList.loanMoney}" type="text" class="txt validate[required,minSize[1],maxSize[10]]" placeholder="请输入" />元</td>
               </tr>
               <tr>
                  <th>实际还款日</th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].repaymentDate" value="${jltfispPsInfoList.repaymentDate}" type="text" class="txt validate[required]" placeholder="请输入" onClick="WdatePicker()" readonly="readonly" /></td>
                  <th>实际支付本息(本金+利息)</th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].principalInterest"  value="${jltfispPsInfoList.principalInterest}" type="text" class="txt validate[required,custom[numberAnddit], minSize[1],maxSize[10]]" placeholder="请输入" />元</td>
               </tr>
               <tr>
                  <th>实际放贷日</th>
                  <td><input name="jltfispPsInfoList[${jltfispPsInfoList_index}].lendDate" type="text" value="${jltfispPsInfoList.lendDate}" class="txt validate[required]" placeholder="请输入实际放贷日" onClick="WdatePicker()" readonly="readonly" /></td>
                  <th>贷款期限</th>
          ...
          <table width="100%" class="tab3 module">
              ...
              <tr>
                  <th style="width:8%">借款合同编号</th>
                  <td colspan="3"><input  name="jltfispPsInfoList[0].contractNumber"  type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入合同编号" /></td>
              </tr>
              <tr>
                  <th><b class="red">*</b><b>保单号</b></th>
                  <td><input name="jltfispPsInfoList[0].policyNumber" type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入" /></td>
                  <th><b class="red">*</b><b>担保金额</b></th>
                  <td><input name="jltfispPsInfoList[0].premiumMoney" type="text" class="txt validate[required,minSize[1],maxSize[10]]" placeholder="请输入" />万元</td>
              </tr>
              <tr>
                  <th><b class="red">*</b><b>贷款银行</b></th>
                  <td>
                      <input name="jltfispPsInfoList[0].loanBank" type="text" class="txt validate[required,minSize[1],maxSize[1000]]" placeholder="请输入" />
                  </td>
                  <th><b class="red">*</b><b>保险/担保公司</b></th>
                  <td>
              ...
              <tr>
                  <th>实际支付保额金额</th>
                   <td colspan="3"><input name="jltfispPsInfoList[0].loanMoney" type="text" class="txt validate[required,minSize[1],maxSize[10]]" placeholder="请输入" />元</td>
              </tr>
              <tr>
                  <th>实际还款日</th>
                  <td><input name="jltfispPsInfoList[0].repaymentDate" type="text" class="txt validate[required]" placeholder="请输入" onClick="WdatePicker()" readonly="readonly" /></td>
                  <th>实际支付本息(本金+利息)</th>
                  <td><input name="jltfispPsInfoList[0].principalInterest" type="text" class="txt validate[required,custom[numberAnddit], minSize[1],maxSize[10]]" placeholder="请输入" />元</td>
              </tr>
              <tr>
                  <th>实际放贷日</th>
                  <td><input name="jltfispPsInfoList[0].lendDate" type="text" class="txt validate[required]" placeholder="请输入实际放贷日" onClick="WdatePicker()" readonly="readonly" /></td>
                  <th>贷款期限</th>
                  <td><input name="jltfispPsInfoList[0].loanTerm" type="text" class="txt validate[required,custom[onlyNumberSp],minSize[1],maxSize[10]]" placeholder="请输入贷款期限" /></td>
              </tr>
            </table>
          </#if>
         </form>
