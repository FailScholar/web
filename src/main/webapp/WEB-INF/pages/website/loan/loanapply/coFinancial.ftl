                        ...
                        <div class="nlistCont" style="display:none;">
                            ...
                            <table width="100%" class="tab3 tab4">
                                ...
                                <tr>
                                    ...
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[20].startTime?exists)>${coAll.jltfispCoFinancialList[20].startTime?date}</#if>" name="startTime" id="startTime1" readonly onClick="WdatePicker({maxDate:'#F{$dp.$D(\'endTime1\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[20].endTime?exists)>${coAll.jltfispCoFinancialList[20].endTime?date}</#if>" name="endTime" id="endTime1" readonly onClick="WdatePicker({minDate:'#F{$dp.$D(\'startTime1\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                </tr>
                                <tr>
                                	<td>2</td>
                                    ...
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[21].startTime?exists)>${coAll.jltfispCoFinancialList[21].startTime?date}</#if>" name="startTime" id="startTime2" readonly onClick="WdatePicker({maxDate:'#F{$dp.$D(\'endTime2\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[21].endTime?exists)>${coAll.jltfispCoFinancialList[21].endTime?date}</#if>" name="endTime" id="endTime2" readonly onClick="WdatePicker({minDate:'#F{$dp.$D(\'startTime2\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                </tr>
                                <tr>
                                	<td>3</td>
                                    ...
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[22].startTime?exists)>${coAll.jltfispCoFinancialList[22].startTime?date}</#if>" name="startTime" id="startTime3" readonly onClick="WdatePicker({maxDate:'#F{$dp.$D(\'endTime3\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[22].endTime?exists)>${coAll.jltfispCoFinancialList[22].endTime?date}</#if>" name="endTime" id="endTime3" readonly onClick="WdatePicker({minDate:'#F{$dp.$D(\'startTime3\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                </tr>
                                <tr>
                                	<td>4</td>
                                    ...
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[23].startTime?exists)>${coAll.jltfispCoFinancialList[23].startTime?date}</#if>" name="startTime" id="startTime4" readonly onClick="WdatePicker({maxDate:'#F{$dp.$D(\'endTime4\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                    <td><input value="<#if (coAll.jltfispCoFinancialList[23].endTime?exists)>${coAll.jltfispCoFinancialList[23].endTime?date}</#if>" name="endTime" id="endTime4" readonly onClick="WdatePicker({minDate:'#F{$dp.$D(\'startTime4\')}',readOnly:true})" type="text" class="txt2 validate[required]" /></td>
                                </tr>
                                <tr>
